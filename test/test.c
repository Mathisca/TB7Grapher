...
//
void testAnalyst() {
    char chaine[50] = "sin(x+2)";
    ElementList list0 = RecognizeLexem(chaine);
}
   /* char chaine1[50] = "cos(x)";
    ElementList list1 = RecognizeLexem(chaine1);
    char chaine2[50] = "1/x";
    ElementList list2 = RecognizeLexem(chaine2);
    char chaine3[50] = "exp(x)";
    ElementList list3 = RecognizeLexem(chaine3);
    char chaine4[50] = "sqrt(5*x)";
    ElementList list4 = RecognizeLexem(chaine4);
    char chaine[50] = "coss(x)";
    ElementList list5 = RecognizeLexem(chaine5);
    char chaine[50] = "vsinh(x+2)";
    ElementList list6 = RecognizeLexem(chaine6);
*/
//
//
//}
